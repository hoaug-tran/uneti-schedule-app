...
const TRANSLATIONS = {
  vi: {
    ...
    gpaCurrentSemSummary: "{credits} TC đăng ký",
    ...
    gpaAutoSuggestBtn: "Gợi ý tự động",
    gpaProjectedCol: "Dự kiến",
    gpaTargetCol: "Mục tiêu",
    gpaTargetLabel: "Mục tiêu",
    gpaCustomSelected: "Đã chọn: {count} môn ({credits} TC)",
    gpaCustomSelectSubject: "Chọn",
    gpaCustomUnselect: "Xoá",
    gpaCustomReset: "Đặt lại gợi ý",
    gpaCustomNeedMore: "Cần chọn thêm ít nhất {credits} TC",
    gpaCustomDeficit: "Còn thiếu {delta} GPA",
    gpaCustomTargetAchieved: "Đạt mục tiêu ({gpa})",
    gpaCustomInsufficientNotice: "Chưa đủ để đạt mục tiêu",
    gpaCustomNeedGrade: "Cần {grade}",
    gpaCustomClickToToggle: "Bấm để chọn/bỏ chọn môn cải thiện",
  },
  en: {
    ...
    gpaCurrentSemSummary: "{credits} Registered Credits",
    gpaTagNoGpa: "Non-GPA",
    ...
    gpaAutoSuggestBtn: "Auto suggest",
    gpaProjectedCol: "Projected",
    gpaTargetCol: "Target",
    gpaTargetLabel: "Target",
    gpaCustomSelected: "Selected: {count} courses ({credits} cr)",
    gpaCustomSelectSubject: "Select",
    gpaCustomUnselect: "Remove",
    gpaCustomReset: "Reset suggestions",
    gpaCustomNeedMore: "Need at least {credits} more credits",
    gpaCustomDeficit: "Deficit of {delta} GPA",
    gpaCustomTargetAchieved: "Target achieved ({gpa})",
    gpaCustomInsufficientNotice: "Insufficient to reach target",
    gpaCustomNeedGrade: "Need {grade}",
    gpaCustomClickToToggle: "Click to select/unselect for improvement",
  },
};
