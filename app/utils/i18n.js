...
const TRANSLATIONS = {
  vi: {
    ...
    period: "Tiết",
    instructor: "GV",
    noClass: "Không có lịch học trong ngày",
    ...
    staleDataWarning: "Dữ liệu lịch có thể đã cũ. Vui lòng Đăng xuất và Đăng nhập lại để làm mới.",
    ...
    gpaCreditsUnit: "TC",
    gpaNotLoggedInTitle: "Chưa đăng nhập",
    gpaNotLoggedInDesc: "Bạn cần đăng nhập để xem bảng điểm và tính GPA.",
    gpaSummaryActual: "Thực tế",
    gpaSummaryProjected: "Dự kiến",
    gpaSummaryDelta: "Chênh lệch",
    gpaSummaryCredits: "TC tích lũy",
    gpaSummaryRank: "Xếp loại",
    gpaPlanImprove: "Cần cải thiện",
    gpaPlanAchieved: "Đã đạt {target}",
    gpaPlanImpossible: "Mục tiêu vượt mức tối đa",
    gpaResetBtn: "Xóa điểm dự kiến",
    gpaProjectedCol: "Dự kiến",
    gpaTargetCol: "Mục tiêu",
    gpaTargetLabel: "Mục tiêu",
  },
  en: {
    ...
    staleDataWarning: "Schedule data may be outdated. Please Logout and Login again to refresh.",
    ...
    gpaNotLoggedInTitle: "Not Logged In",
    gpaNotLoggedInDesc: "Please log in to view your academic transcript and GPA.",
    gpaSummaryActual: "Actual",
    gpaSummaryProjected: "Projected",
    gpaSummaryDelta: "Change",
    gpaSummaryCredits: "Earned Credits",
    gpaSummaryRank: "Academic Rank",
    gpaPlanImprove: "Improve",
    gpaPlanAchieved: "Achieved {target}",
    gpaPlanImpossible: "Target exceeds maximum",
    gpaResetBtn: "Reset Projected",
    gpaProjectedCol: "Projected",
    gpaTargetCol: "Target",
    gpaTargetLabel: "Target",
  },
};
